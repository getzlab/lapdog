...
<template lang="html">
  <div id="submission">
    ...
    <h4>
      <router-link v-if="submission && submission.AUTHORIZED_DOMAIN" :to="{name: 'workspace', params: {namespace: namespace, workspace: lodash.split(submission.AUTHORIZED_DOMAIN, '/')[1]}}">
        <i class="material-icons tiny">arrow_back</i>  <span class="icon-align-header">{{namespace}}/{{lodash.split(submission.AUTHORIZED_DOMAIN, '/')[1]}}</span>
      </router-link>
